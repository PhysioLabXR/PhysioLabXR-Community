...
from rena.sub_process.TCPInterface import RenaTCPInterface, RenaTCPClientArchive, RenaTCPObject
...
dsp_client_interface = RenaTCPInterface(stream_name='John',
                                        port_id=111,
                                        identity='client')
dsp_client = RenaTCPClientArchive(RENATCPInterface=dsp_client_interface)
