...
from rena.sub_process.server_workers import DSPServerWorker, RenaDSPServerMasterWorker

if __name__ == '__main__':
    print("Server Started")
    rena_tcp_interface = RenaTCPInterface(stream_name=config.rena_server_name, port_id=config.rena_server_port, identity='server')
    rena_dsp_server_master_worker = RenaDSPServerMasterWorker(RenaTCPInterface=rena_tcp_interface)
