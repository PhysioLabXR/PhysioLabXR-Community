...
class GroupEntry:
    ...
    def __post_init__(self):
        ...
        # if self.is_channels_shown is None:  # will only modify the channel indices if it is not set. It could be set from loading a preset
