...
if __name__ == '__main__':
    ...
    tray_icon = QSystemTrayIcon(QIcon('src/media/icon.PNG'), parent=app)
    tray_icon.setToolTip('RNApp')
    tray_icon.show()

    # splash screen
    splash = QLabel()
    pixmap = QPixmap('src/media/logo/RN.png')
    ...
    window.setWindowIcon(QIcon('src/media/logo/RN.png'))
    # make tray menu
    menu = QMenu()
    ...
    stylesheet = QFile('src/ui/stylesheet/dark.qss')
