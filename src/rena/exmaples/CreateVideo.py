...
from src.rena.utils.data_utils import RNStream
...
out = cv2.VideoWriter(out_path, cv2.VideoWriter_fourcc(*'DIVX'), 1 / config.CAMERA_SCREENCAPTURE_REFRESH_INTERVAL, frame_size)
