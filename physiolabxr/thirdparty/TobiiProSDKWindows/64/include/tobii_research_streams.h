...
typedef struct {
    ...
    */
    ...
    /**
    DEPRECATED: The normalized gaze origin position in 3D in the track box coordinate system. This will be removed in future versions!!!
    */
...
typedef enum {
    ...
    */
    ...
    /**
     * Indicates that a stream buffer overflow has occured. This is most commonly due to callbacks not consuming data from the stream fast enough.
    */
