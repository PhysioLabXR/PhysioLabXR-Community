...
**FORKed from the original SAM-2 repo, please check the documentation in [Detailed Instructions](liinc_pipeline/README.md)**


# Rest of the document belongs to original Meta SAM-2 Repo
