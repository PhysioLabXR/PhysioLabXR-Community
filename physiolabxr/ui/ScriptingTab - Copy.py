...
class ScriptingTab(QtWidgets.QWidget):
    ...
    def add_script_widget(self, script_preset=None):
        script_widget = ScriptingWidget(self, self.parent, script_preset=script_preset, layout=self.ScriptingWidgetScrollLayout)  # reverse three ports for each scripting widget
