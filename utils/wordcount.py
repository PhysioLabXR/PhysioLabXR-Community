...
def run(argv=['input','output'], save_main_session=True):
  ...
  pipeline_options = PipelineOptions(runner='DataflowRunner',temp_location="gs://"+BUCKET+"/tmp", project=PROJECT, region=REGION)
