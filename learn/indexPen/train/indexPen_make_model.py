...
def make_model_leo(classes, points_per_sample, channel_mode='channels_last', batch_size=32):
    ...
    mmw_rdpl_input = (int(points_per_sample),) + config_signal.rd_shape + (1,) if channel_mode == 'channels_last' else (points_per_sample, 1) + config_signal.rd_shape
    ...
    mmw_razi_input = (int(points_per_sample),) + config_signal.ra_shape + (1,) if channel_mode == 'channels_last' else (points_per_sample, 1) + config_signal.ra_shape
